#ifndef SNPLIB_MULTI_MLM_RML_H
#define SNPLIB_MULTI_MLM_RML_H
...
class MultiMLMRML {
 ...
 public:
  MultiMLMRML(const double *lambda, size_t num_samples, size_t num_covariates_,
              size_t num_dims);
  ~MultiMLMRML() noexcept;
